...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_account_member->editMember($this->request->post);
	...
	protected function validate() {
		...
		if (($this->member->getEmail() != $this->request->post['email']) && $this->model_account_member->getTotalMembersByEmail($this->request->post['email'])) {
