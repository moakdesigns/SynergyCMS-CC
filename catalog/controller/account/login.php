...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		if (!empty($this->request->get['token'])) {
			...
			$member_info = $this->model_account_member->getMemberByToken($this->request->get['token']);
			
		 	if ($member_info && $this->member->login($member_info['email'], '', true)) {
				// Default Addresses
				$this->load->model('account/address');
					
				$address_info = $this->model_account_address->getAddress($this->member->getAddressId());
