...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
		...
		$member_group_info = $this->model_account_member_group->getMemberGroup($this->member->getMemberGroupId());
		...
		if (isset($this->request->post['zipcode'])) {
			...
			$this->data['zipcode'] = $address_info['zipcode'];			
		} else {
			$this->data['zipcode'] = '';
		}
		...
		if (isset($this->request->post['default'])) {
			...
			$this->data['default'] = $this->member->getAddressId() == $this->request->get['address_id'];
		} else {
	...
	protected function validateDelete() {
		...
		if ($this->member->getAddressId() == $this->request->get['address_id']) {
