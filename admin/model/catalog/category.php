...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		if (isset($data['category_site'])) {
			foreach ($data['category_site'] as $site_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "category_to_site SET 
					category_id = '" . (int)$category_id . "', 
					site_id = '" . (int)$site_id . "'");
			}
		}
		...
		if (isset($data['category_layout'])) {
			foreach ($data['category_layout'] as $site_id => $layout) {
				if ($layout['layout_id']) {
	...
	public function editCategory($category_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_to_site 
			WHERE category_id = '" . (int)$category_id . "'");
	...
	public function deleteCategory($category_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_to_site WHERE category_id = '" . (int)$category_id . "'");
	...
	public function getCategorySites($category_id) {
		$category_site_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_to_site WHERE category_id = '" . (int)$category_id . "'");

		foreach ($query->rows as $result) {
			$category_site_data[] = $result['site_id'];
		}

		return $category_site_data;
	}
	...
	public function getCategoryLayouts($category_id) {
		...
		foreach ($query->rows as $result) {
			$category_layout_data[$result['site_id']] = $result['layout_id'];
		}
