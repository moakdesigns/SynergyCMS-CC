...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		if (isset($data['manufacturer_site'])) {
			foreach ($data['manufacturer_site'] as $site_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_to_site SET manufacturer_id = '" . (int)$manufacturer_id . "', site_id = '" . (int)$site_id . "'");
			}
		}
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "manufacturer_to_site WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
	...
	public function getManufacturerSites($manufacturer_id) {
		$manufacturer_site_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "manufacturer_to_site WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");

		foreach ($query->rows as $result) {
			$manufacturer_site_data[] = $result['site_id'];
		}

		return $manufacturer_site_data;
	}
