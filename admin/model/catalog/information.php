...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		if (isset($data['information_site'])) {
			foreach ($data['information_site'] as $site_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "information_to_site SET information_id = '" . (int)$information_id . "', site_id = '" . (int)$site_id . "'");
			}
		}

		if (isset($data['information_layout'])) {
			foreach ($data['information_layout'] as $site_id => $layout) {
				if ($layout) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "information_to_layout SET information_id = '" . (int)$information_id . "', site_id = '" . (int)$site_id . "', layout_id = '" . (int)$layout['layout_id'] . "'");
				}
			}
		}
	...
	public function editInformation($information_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "information_to_site WHERE information_id = '" . (int)$information_id . "'");
	...
	public function getInformationSites($information_id) {
		$information_site_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "information_to_site WHERE information_id = '" . (int)$information_id . "'");
