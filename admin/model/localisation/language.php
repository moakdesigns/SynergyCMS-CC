...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "language 
...
//----------------------------------------------------
		...
		// Member Group
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "member_group_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $member_group) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "member_group_description SET member_group_id = '" . (int)$member_group['member_group_id'] . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($member_group['name']) . "', description = '" . $this->db->escape($member_group['description']) . "'");
		}
...
//------------------------------------------------------------
		...
		foreach ($query->rows as $post) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "post_description SET post_id = '" . (int)$post['post_id'] . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($post['title']) . "', meta_description = '" . $this->db->escape($post['meta_description']) . "', meta_keyword = '" . $this->db->escape($post['meta_keyword']) . "', description = '" . $this->db->escape($post['description']) . "', tag = '" . $this->db->escape($post['tag']) . "'");
		}

		$this->cache->delete('post');
//-----------------------------------------------------------
		// Post Attribute 
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "post_attribute WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $post_attribute) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "post_attribute SET product_id = '" . (int)$post_attribute['post_id'] . "', attribute_id = '" . (int)$post_attribute['attribute_id'] . "', language_id = '" . (int)$language_id . "', text = '" . $this->db->escape($post_attribute['text']) . "'");
		}
	...
	public function editLanguage($language_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "language 
			SET name = '" . $this->db->escape($data['name']) . "', 
			code = '" . $this->db->escape($data['code']) . "', 
			locale = '" . $this->db->escape($data['locale']) . "', 
			directory = '" . $this->db->escape($data['directory']) . "', 
	...
	public function deleteLanguage($language_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "member_group_description WHERE language_id = '" . (int)$language_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "post_attribute WHERE language_id = '" . (int)$language_id . "'");
