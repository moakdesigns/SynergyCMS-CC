<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/information.png" class="headingIcon" alt="slideshow icon" />
...
<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Slideshow Extension</h3>
        ...
        <table id="module" class="form tile table table-bordered table-striped transbg">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="slideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" /> x
...
function addModule() {	
	...
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="slideshow_module[' + module_row + '][width]" value="" size="3" /> x <input type="text" name="slideshow_module[' + module_row + '][height]" value="" size="3" /></td>';
