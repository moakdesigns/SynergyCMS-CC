<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/information.png" class="headingIcon" alt="latest icon" />
...
<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Latest Extension</h3>
        ...
        <table id="module" class="form tile table table-bordered table-striped transbg">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="latest_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" /> x
...
function addModule() {	
	...
	html += '    <td class="left"><input type="text" name="latest_module[' + module_row + '][image_width]" value="80" size="3" /> x <input type="text" name="latest_module[' + module_row + '][image_height]" value="80" size="3" /></td>';
