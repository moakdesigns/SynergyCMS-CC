...
<div id="container" class="container">  <?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Banner Extension</h3>
        ...
        <table id="module" class="form tile table table-bordered table-striped transbg">
          <thead>
            <tr>
              ...
              <th class="left"><span class="required">*</span> <?php echo $entry_dimension; ?></th>
...
function addModule() {	
	...
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="banner_module[' + module_row + '][width]" value="" size="3" /> x <input type="text" name="banner_module[' + module_row + '][height]" value="" size="3" /></td>'; 
