...
<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Site Extension</h3>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="table-responsive">
        <table class="form tile table table-bordered table-striped transbg">
          <tr>
            ...
            <td><?php if ($site_admin) { ?>
              <input type="radio" name="site_admin" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="site_admin" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="site_admin" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="site_admin" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
        </table>
        ...
        <table id="module" class="form tile table table-bordered table-striped transbg">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="site_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="site_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left"><select name="site_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="right"><input type="text" name="site_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="site_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="site_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="left"><select name="site_module[' + module_row + '][status]">';
    html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="site_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
