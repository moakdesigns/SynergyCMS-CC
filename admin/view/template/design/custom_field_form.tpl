...
<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Custom Field Form</h3>
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="table-responsive">
        <table class="form tile table table-bordered table-striped transbg">
          ...
          <tr>
            ...
            <td><select name="location">
                <?php if ($location == 'member') { ?>
                <option value="member" selected><?php echo $text_member; ?></option>
                <?php } else { ?>
        ...
        <hr>
        <table id="custom-field-value" class="tile table table-bordered table-striped transbg">
          <thead>
            <tr>
              <th class="left"><span class="required">*</span> <?php echo $entry_custom_value; ?></th>
          ...
          <tbody id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#custom-field-value-row<?php echo $custom_field_value_row; ?>').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          ...
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addCustomFieldValue();" class="btn btn-warning"><?php echo $button_add_custom_field_value; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addCustomFieldValue() {
	...
	html += '    <td class="left"><a onclick="$(\'#custom-field-value-row' + custom_field_value_row + '\').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
