<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/country.png" class="headingIcon" alt="country icon" />
...
<?php if ($error_warning) { ?>
  ...
  <div class="box">    
    <div class="heading">
      <h3 class="formTitle">Country Form</h3>
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="table-responsive">
        <table class="form tile table table-bordered table-striped transbg">
          ...
          <tr>
            <td><?php echo $entry_zipcode_required; ?></td>
            <td><?php if ($zipcode_required) { ?>
              <input type="radio" name="zipcode_required" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="zipcode_required" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="zipcode_required" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="zipcode_required" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
