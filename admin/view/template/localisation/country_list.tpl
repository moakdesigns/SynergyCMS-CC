<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/information.png" class="headingIcon" alt="country icon" />
...
<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Country List</h3>
          ...
          <thead>
            <tr>
              ...
              <th class="left"><?php if ($sort == 'name') { ?>
                ...
                <?php } ?></th>
              <th class="left"><?php if ($sort == 'iso_code_2') { ?>
                ...
                <?php } ?></th>
              <th class="left"><?php if ($sort == 'iso_code_3') { ?>
