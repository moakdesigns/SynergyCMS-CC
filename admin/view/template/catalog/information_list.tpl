<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/information.png" class="headingIcon" alt="information icon" />
...
<div id="container" class="container">  <?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Information List</h3>
        ...
        <table class="tile table table-bordered table-striped transbg">
          <thead>
            <tr>
              ...
              <th class="left"><?php if ($sort == 'id.title') { ?>
                <a href="<?php echo $sort_title; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_title; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_title; ?>"><?php echo $column_title; ?></a>
                <?php } ?></th>
              <th class="left"><?php if ($sort == 'i.sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $information['sort_order']; ?></td>
