...
<div id="container" class="container">  <?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Filter Form</h3>
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="table-responsive">
        ...
        <hr />
        <table id="filter" class="tile table table-bordered table-striped transbg">
          <thead>
            <tr>
              <th class="left"><span class="required">*</span> <?php echo $entry_name ?></th>
          ...
          <tbody id="filter-row<?php echo $filter_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#filter-row<?php echo $filter_row; ?>').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $filter_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addFilter();" class="btn btn-warning"><?php echo $button_add_filter; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addFilter() {
	...
	html += '     <td class="left"><a onclick="$(\'#filter-row' + filter_row + '\').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
