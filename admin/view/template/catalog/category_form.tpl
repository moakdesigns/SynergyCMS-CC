<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/category.png" class="headingIcon" alt="category icon" />
...
<div id="container" class="container">
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Category Form</h3> 
            ...
            <table class="tile table table-bordered table-striped transbg">
              <tr>
                ...
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?>" />
                  ...
                  <span class="label label-danger"><?php echo $error_name[$language['language_id']]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">
                    <?php if (in_array(0, $category_site)) { ?>
                    <input type="checkbox" name="category_site[]" value="0" checked="checked" />
                    <?php echo $text_default; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="category_site[]" value="0" />
                    <?php echo $text_default; ?>
                    <?php } ?>
                  </div>
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
                    <?php if (in_array($site['site_id'], $category_site)) { ?>
                    <input type="checkbox" name="category_site[]" value="<?php echo $site['site_id']; ?>" checked="checked" />
                    <?php echo $site['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="category_site[]" value="<?php echo $site['site_id']; ?>" />
                    <?php echo $site['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
          ...
          <table class="tile table table-bordered table-striped transbg">
            ...
            <tbody>
              <tr>
                ...
                <td class="left" style="width:85%;"><select name="category_layout[0][layout_id]">
                    <option value=""></option>
            ...
            <tbody>
              <tr>
                ...
                <td class="left" style="width:85%;"><select name="category_layout[<?php echo $site['site_id']; ?>][layout_id]">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
                    <?php if (isset($category_layout[$site['site_id']]) && $category_layout[$site['site_id']] == $layout['layout_id']) { ?>
                    <option value="<?php echo $layout['layout_id']; ?>" selected="selected"><?php echo $layout['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>
                    <?php } ?>
...
$('#category-filter div img').click(function() {
	$(this).parent().remove();
