<?php echo $header; ?>
<div class="pageTitle">
  <img src="view/image/order.png" class="headingIcon" alt="attribute title icon" />
...
<div id="container" class="container">
  ...
  <div class="box">
    <div class="heading">
      <h3 class="formTitle">Attribute Group List</h3>
        ...
        <table class="tile table table-bordered table-striped transbg">
          <thead>
            <tr>
              ...
              <th class="left"><?php if ($sort == 'agd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></th>
              <th class="right"><?php if ($sort == 'ag.sort_order') { ?>
