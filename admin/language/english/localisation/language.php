...
$_['error_default']     = 'Warning: This language cannot be deleted as it is currently assigned as the default site language!';
$_['error_admin']       = 'Warning: This Language cannot be deleted as it is currently assigned as the administration language!';
$_['error_site']       = 'Warning: This language cannot be deleted as it is currently assigned to %s sites!';
