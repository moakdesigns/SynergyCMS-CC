...
$_['entry_catalog_limit'] 	       = 'Default Items Per Page (Catalog):<br /><span class="help">Determines how many items are shown per page</span>';
$_['entry_admin_limit']   	       = 'Default Items Per Page (Admin):<br /><span class="help">Determines how many admin items are shown per page</span>';
$_['entry_post_count']          = 'Category Post Count:<br /><span class="help">Show the number of posts inside the subcategories in the site front header category menu. Be warned, this will cause an extreme performance hit for sites with a lot of subcategories!</span>';
...
$_['entry_member_online']        = 'Members Online:<br /><span class="help">Track members online via the member reports section.</span>';
$_['entry_member_group']         = 'Member Group:<br /><span class="help">Default member group.</span>';
$_['entry_member_group_display'] = 'Member Groups:<br /><span class="help">Display member groups that new members can select when signing up.</span>';
...
$_['entry_image_additional']       = 'Additional Post Images Size:';
...
$_['entry_ftp_root']               = 'FTP Root:<span class="help">The directory your SynergyCMS installation is stored in normally \'public_html/\'.</span>';
...
$_['entry_mail_parameter']         = 'Mail Parameters:<span class="help">When using \'Mail\', additional mail parameters can be added here (e.g. "-femail@siteaddress.com").</span>';
...
$_['entry_account_mail']           = 'New Account Alert Mail:<br /><span class="help">Send a email to the site owner when a new account is registered.</span>';
...
$_['entry_alert_emails']           = 'Additional Alert E-Mails:<br /><span class="help">Any additional emails you want to receive the alert email, in addition to the main site email. (comma separated)</span>';
...
$_['entry_shared']                 = 'Use Shared Sessions:<br /><span class="help">Try to share the session cookie between sites on different domains.</span>';
...
$_['entry_maintenance']            = 'Maintenance Mode:<br /><span class="help">Prevents visitors from browsing your site. They will instead see a maintenance message. If logged in as admin, you will see the site as normal.</span>';
...
$_['entry_encryption']             = 'Encryption Key:<br /><span class="help">Please provide a secret key that will be used to encrypt private information.</span>';
...
$_['error_address']                = 'Address must be between 10 and 256 characters!';
