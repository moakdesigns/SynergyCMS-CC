...
$_['entry_catalog_limit'] 	       = 'Default Items Per Page (Feed):<br /><span class="help">Determines how many Feed items are shown per page (posts, categories, etc)</span>';
$_['entry_member_group']         = 'Customer Group:<br /><span class="help">Default member group.</span>';
$_['entry_member_group_display'] = 'Customer Groups:<br /><span class="help">Display member groups that new members can select signing up.</span>';
...
$_['error_member_group_display'] = 'You must include the default member group if you are going to use this feature!';
...
$_['error_site']                  = 'Warning: This Site cannot be deleted.';
...
// $_['entry_tax_default']            = 'Use Site Tax Address:<br /><span class="help">Use the site address to calculate taxes if no one is logged in. You can choose to use the site address for the members shipping or payment address.</span>';
// $_['entry_tax_member']           = 'Use Customer Tax Address:<br /><span class="help">Use the members default address when they login to calculate taxes. You can choose to use the default address for the members shipping or payment address.</span>';
// $_['entry_member_price']         = 'Login Display Prices:<br /><span class="help">Only show prices when a member is logged in.</span>';
// $_['entry_cart_weight']            = 'Display Weight on Cart Page:';
// $_['entry_guest_checkout']         = 'Guest Checkout:<br /><span class="help">Allow members to checkout without creating an account. This will not be available when a downloadable item is in the shopping cart.</span>';
// $_['entry_checkout']               = 'Checkout Terms:<br /><span class="help">Forces people to agree to terms before an a member can checkout.</span>';
...
// $_['entry_stock_checkout']         = 'Stock Checkout:<br /><span class="help">Allow members to still checkout if the posts they are ordering are not in stock.</span>';
