...
// Error
$_['error_install']                 = '<span class="fa fa-warning"> </span> Warning: Install folder still exists and should be deleted for security reasons!';
$_['error_image']                   = '<span class="fa fa-warning"> </span> Warning: Image directory %s not writeable!';
$_['error_image_cache']             = '<span class="fa fa-warning"> </span> Warning: Image cache directory %s not writeable!';
$_['error_cache']                   = '<span class="fa fa-warning"> </span> Warning: Cache directory %s not writeable!';
$_['error_download']                = '<span class="fa fa-warning"> </span> Warning: Download directory %s not writeable!';
$_['error_logs']                    = '<span class="fa fa-warning"> </span> Warning: Log directory %s not writeable!';
?>