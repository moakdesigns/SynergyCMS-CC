...
// Error 
$_['error_warning']          = '<span class="fa fa-warning"> </span> Warning: Please check the form carefully for errors!';
$_['error_permission']       = '<span class="fa fa-warning"> </span> Warning: You do not have permission to modify categories!';
