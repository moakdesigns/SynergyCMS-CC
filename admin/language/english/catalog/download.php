...
$_['entry_filename']   = 'Filename:<br /><span class="help">You can upload via the upload button or use FTP to upload to the download directory and enter the details below.<br />It is also recommended that the filename and the mask are different to stop people trying to directly link to your downloads.</span>';
$_['entry_mask']       = 'Mask:';
...
$_['error_post']    = 'Warning: This download cannot be deleted as it is currently assigned to %s posts!';
?>