...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['featured_post'])) {
			$this->data['featured_post'] = $this->request->post['featured_post'];
		} else {
			$this->data['featured_post'] = $this->config->get('featured_post');
		}	

		$this->load->model('catalog/post');

		if (isset($this->request->post['featured_post'])) {
			$posts = explode(',', $this->request->post['featured_post']);
		} else {		
