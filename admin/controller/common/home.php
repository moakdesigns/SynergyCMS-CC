...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		// $this->data['text_total_members'] = $this->language->get('text_total_members');
		// $this->data['text_total_members_year'] = $this->language->get('text_total_members_year');
		...
		// $this->data['total_members'] = $this->currency->format($this->model_members_order->getTotalSales(), $this->config->get('config_currency'));
		// $this->data['total_members_year'] = $this->currency->format($this->model_members_order->getTotalSalesByYear(date('Y')), $this->config->get('config_currency'));
		// $this->data['total_order'] = $this->model_members_order->getTotalOrders();
		...
		// $this->data['total_affiliate'] = $this->model_members_affiliate->getTotalAffiliates();
		// $this->data['total_affiliate_approval'] = $this->model_members_affiliate->getTotalAffiliatesAwaitingApproval();
		...
		// $results = $this->model_members_order->getOrders($data);
		...
		// 		'href' => $this->url->link('members/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'], 'SSL')
		// 	);
