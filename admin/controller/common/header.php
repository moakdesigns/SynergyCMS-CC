...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_member_field'] = $this->language->get('text_member_field');
		...
		$this->data['text_synergycms'] = $this->language->get('text_synergycms');
		...
		// $this->data['text_report_member_order'] = $this->language->get('text_report_member_order');
		// $this->data['text_report_member_reward'] = $this->language->get('text_report_member_reward');
		// $this->data['text_report_member_credit'] = $this->language->get('text_report_member_credit');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['member_fields'] = $this->url->link('members/member_field', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['post'] = $this->url->link('catalog/post', 'token=' . $this->session->data['token'], 'SSL');
			...
			// $this->data['report_member_order'] = $this->url->link('report/member_order', 'token=' . $this->session->data['token'], 'SSL');
			// $this->data['report_member_reward'] = $this->url->link('report/member_reward', 'token=' . $this->session->data['token'], 'SSL');
			// $this->data['report_member_credit'] = $this->url->link('report/member_credit', 'token=' . $this->session->data['token'], 'SSL');
