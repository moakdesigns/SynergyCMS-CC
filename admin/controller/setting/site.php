<?php
class ControllerSettingSite extends Controller {
	private $error = array(); 

	public function index() {
		$this->language->load('setting/site');
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$site_id = $this->model_setting_site->addSite($this->request->post);

			$this->load->model('setting/setting');

			$this->model_setting_setting->editSetting('config', $this->request->post, $site_id);

			$this->session->data['success'] = $this->language->get('text_success');

			$this->redirect($this->url->link('setting/site', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_setting_site->editSite($this->request->get['site_id'], $this->request->post);

			$this->load->model('setting/setting');

			$this->model_setting_setting->editSetting('config', $this->request->post, $this->request->get['site_id']);

			$this->session->data['success'] = $this->language->get('text_success');

			$this->redirect($this->url->link('setting/site', 'token=' . $this->session->data['token'] . '&site_id=' . $this->request->get['site_id'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('setting/site', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' / '
		);

		$this->data['insert'] = $this->url->link('setting/site/insert', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['delete'] = $this->url->link('setting/site/delete', 'token=' . $this->session->data['token'], 'SSL');	
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('setting/site/update', 'token=' . $this->session->data['token'] . '&site_id=' . $result['site_id'], 'SSL')
			);
		...
		$this->template = 'setting/site_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function getForm() { 
		...
		// $this->data['entry_tax_member'] = $this->language->get('entry_tax_member');		
		$this->data['entry_member_group'] = $this->language->get('entry_member_group');
		$this->data['entry_member_group_display'] = $this->language->get('entry_member_group_display');
		// $this->data['entry_member_price'] = $this->language->get('entry_member_price');
		...
		if (isset($this->error['member_group_display'])) {
			$this->data['error_member_group_display'] = $this->error['member_group_display'];
		} else {
			$this->data['error_member_group_display'] = '';
		}
		...
		if (!isset($this->request->get['site_id'])) {
			$this->data['action'] = $this->url->link('setting/site/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('setting/site/update', 'token=' . $this->session->data['token'] . '&site_id=' . $this->request->get['site_id'], 'SSL');
		}

		$this->data['cancel'] = $this->url->link('setting/site', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->get['site_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$this->load->model('setting/setting');

			$site_info = $this->model_setting_setting->getSetting('config', $this->request->get['site_id']);
		}
		...
		} elseif (isset($site_info['config_url'])) {
			$this->data['config_url'] = $site_info['config_url'];
		} else {
		...
		} elseif (isset($site_info['config_ssl'])) {
			$this->data['config_ssl'] = $site_info['config_ssl'];
		} else {
		...
		} elseif (isset($site_info['config_name'])) {
			$this->data['config_name'] = $site_info['config_name'];
		} else {
		...
		} elseif (isset($site_info['config_owner'])) {
			$this->data['config_owner'] = $site_info['config_owner'];		
		} else {
		...
		} elseif (isset($site_info['config_address'])) {
			$this->data['config_address'] = $site_info['config_address'];		
		} else {
		...
		} elseif (isset($site_info['config_email'])) {
			$this->data['config_email'] = $site_info['config_email'];		
		} else {
		...
		} elseif (isset($site_info['config_telephone'])) {
			$this->data['config_telephone'] = $site_info['config_telephone'];		
		} else {
		...
		} elseif (isset($site_info['config_fax'])) {
			$this->data['config_fax'] = $site_info['config_fax'];		
		} else {
		...
		} elseif (isset($site_info['config_title'])) {
			$this->data['config_title'] = $site_info['config_title'];
		} else {
		...
		} elseif (isset($site_info['config_meta_description'])) {
			$this->data['config_meta_description'] = $site_info['config_meta_description'];		
		} else {
		...
		} elseif (isset($site_info['config_layout_id'])) {
			$this->data['config_layout_id'] = $site_info['config_layout_id'];
		} else {
		...
		} elseif (isset($site_info['config_template'])) {
			$this->data['config_template'] = $site_info['config_template'];
		} else {
		...
		} elseif (isset($site_info['config_country_id'])) {
			$this->data['config_country_id'] = $site_info['config_country_id'];		
		} else {
		...
		} elseif (isset($site_info['config_zone_id'])) {
			$this->data['config_zone_id'] = $site_info['config_zone_id'];				
		} else {
		...
		} elseif (isset($site_info['config_language'])) {
			$this->data['config_language'] = $site_info['config_language'];			
		} else {
		...
		// } elseif (isset($site_info['config_currency'])) {
		// 	$this->data['config_currency'] = $site_info['config_currency'];			
		// } else {
		...
		} elseif (isset($site_info['config_catalog_limit'])) {
			$this->data['config_catalog_limit'] = $site_info['config_catalog_limit'];	
		} else {
		...
		// } elseif (isset($site_info['config_tax'])) {
		// 	$this->data['config_tax'] = $site_info['config_tax'];			
		// } else {
		...
		// } elseif (isset($site_info['config_tax_default'])) {
		// 	$this->data['config_tax_default'] = $site_info['config_tax_default'];			
		// } else {
		// 	$this->data['config_tax_default'] = '';
		// }

		// if (isset($this->request->post['config_tax_member'])) {
		// 	$this->data['config_tax_member'] = $this->request->post['config_tax_member'];
		// } elseif (isset($site_info['config_tax_member'])) {
		// 	$this->data['config_tax_member'] = $site_info['config_tax_member'];			
		// } else {
		// 	$this->data['config_tax_member'] = '';
		// }

		if (isset($this->request->post['config_member_group_id'])) {
			$this->data['config_member_group_id'] = $this->request->post['config_member_group_id'];
		} elseif (isset($site_info['config_member_group_id'])) {
			$this->data['config_member_group_id'] = $site_info['config_member_group_id'];			
		} else {
			$this->data['config_member_group_id'] = '';
		}
		...
		if (isset($this->request->post['config_member_group_display'])) {
			$this->data['config_member_group_display'] = $this->request->post['config_member_group_display'];
		} elseif (isset($site_info['config_member_group_display'])) {
			$this->data['config_member_group_display'] = $site_info['config_member_group_display'];	
		} else {
			$this->data['config_member_group_display'] = array();			
		}

		// if (isset($this->request->post['config_member_price'])) {
		// 	$this->data['config_member_price'] = $this->request->post['config_member_price'];
		// } elseif (isset($site_info['config_member_price'])) {
		// 	$this->data['config_member_price'] = $site_info['config_member_price'];			
		// } else {
		// 	$this->data['config_member_price'] = '';
		// }

		if (isset($this->request->post['config_account_id'])) {
			$this->data['config_account_id'] = $this->request->post['config_account_id'];
		} elseif (isset($site_info['config_account_id'])) {
			$this->data['config_account_id'] = $site_info['config_account_id'];			
		} else {
		...
		// } elseif (isset($site_info['config_cart_weight'])) {
		// 	$this->data['config_cart_weight'] = $site_info['config_cart_weight'];	
		// } else {
		...
		// } elseif (isset($site_info['config_guest_checkout'])) {
		// 	$this->data['config_guest_checkout'] = $site_info['config_guest_checkout'];		
		// } else {
		...
		// } elseif (isset($site_info['config_checkout_id'])) {
		// 	$this->data['config_checkout_id'] = $site_info['config_checkout_id'];		
		// } else {
		...
		// } elseif (isset($site_info['config_order_status_id'])) {
		// 	$this->data['config_order_status_id'] = $site_info['config_order_status_id'];		
		// } else {
		...
		// } elseif (isset($site_info['config_stock_display'])) {
		// 	$this->data['config_stock_display'] = $site_info['config_stock_display'];			
		// } else {
		...
		// } elseif (isset($site_info['config_stock_checkout'])) {
		// 	$this->data['config_stock_checkout'] = $site_info['config_stock_checkout'];		
		// } else {
		...
		} elseif (isset($site_info['config_logo'])) {
			$this->data['config_logo'] = $site_info['config_logo'];			
		} else {
			$this->data['config_logo'] = '';
		}

		if (isset($site_info['config_logo']) && file_exists(DIR_IMAGE . $site_info['config_logo']) && is_file(DIR_IMAGE . $site_info['config_logo'])) {
			$this->data['logo'] = $this->model_tool_image->resize($site_info['config_logo'], 100, 100);		
		} else {
		...
		} elseif (isset($site_info['config_icon'])) {
			$this->data['config_icon'] = $site_info['config_icon'];			
		} else {
			$this->data['config_icon'] = '';
		}

		if (isset($site_info['config_icon']) && file_exists(DIR_IMAGE . $site_info['config_icon']) && is_file(DIR_IMAGE . $site_info['config_icon'])) {
			$this->data['icon'] = $this->model_tool_image->resize($site_info['config_icon'], 100, 100);
		} else {
		...
		} elseif (isset($site_info['config_image_category_height'])) {
			$this->data['config_image_category_height'] = $site_info['config_image_category_height'];			
		} else {
		...
		} elseif (isset($site_info['config_image_thumb_width'])) {
			$this->data['config_image_thumb_width'] = $site_info['config_image_thumb_width'];			
		} else {
		...
		} elseif (isset($site_info['config_image_thumb_height'])) {
			$this->data['config_image_thumb_height'] = $site_info['config_image_thumb_height'];				
		} else {
		...
		} elseif (isset($site_info['config_image_popup_width'])) {
			$this->data['config_image_popup_width'] = $site_info['config_image_popup_width'];			
		} else {
		...
		} elseif (isset($site_info['config_image_popup_height'])) {
			$this->data['config_image_popup_height'] = $site_info['config_image_popup_height'];			
		} else {
			$this->data['config_image_popup_height'] = 500;
		}

		if (isset($this->request->post['config_image_post_width'])) {
			$this->data['config_image_post_width'] = $this->request->post['config_image_post_width'];
		} elseif (isset($site_info['config_image_post_width'])) {
			$this->data['config_image_post_width'] = $site_info['config_image_post_width'];		
		} else {
			$this->data['config_image_post_width'] = 80;
		}

		if (isset($this->request->post['config_image_post_height'])) {
			$this->data['config_image_post_height'] = $this->request->post['config_image_post_height'];
		} elseif (isset($site_info['config_image_post_height'])) {
			$this->data['config_image_post_height'] = $site_info['config_image_post_height'];		
		} else {
			$this->data['config_image_post_height'] = 80;
		}
		...
		} elseif (isset($site_info['config_image_category_width'])) {
			$this->data['config_image_category_width'] = $site_info['config_image_category_width'];			
		} else {
		...
		} elseif (isset($site_info['config_image_additional_width'])) {
			$this->data['config_image_additional_width'] = $site_info['config_image_additional_width'];			
		} else {
		...
		} elseif (isset($site_info['config_image_additional_height'])) {
			$this->data['config_image_additional_height'] = $site_info['config_image_additional_height'];				
		} else {
		...
		// } elseif (isset($site_info['config_image_related_width'])) {
		// 	$this->data['config_image_related_width'] = $site_info['config_image_related_width'];		
		// } else {
		...
		// } elseif (isset($site_info['config_image_related_height'])) {
		// 	$this->data['config_image_related_height'] = $site_info['config_image_related_height'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_compare_width'])) {
		// 	$this->data['config_image_compare_width'] = $site_info['config_image_compare_width'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_compare_height'])) {
		// 	$this->data['config_image_compare_height'] = $site_info['config_image_compare_height'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_wishlist_width'])) {
		// 	$this->data['config_image_wishlist_width'] = $site_info['config_image_wishlist_width'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_wishlist_height'])) {
		// 	$this->data['config_image_wishlist_height'] = $site_info['config_image_wishlist_height'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_cart_width'])) {
		// 	$this->data['config_image_cart_width'] = $site_info['config_image_cart_width'];			
		// } else {
		...
		// } elseif (isset($site_info['config_image_cart_height'])) {
		// 	$this->data['config_image_cart_height'] = $site_info['config_image_cart_height'];			
		// } else {
		...
		} elseif (isset($site_info['config_secure'])) {
			$this->data['config_secure'] = $site_info['config_secure'];
		} else {
			$this->data['config_secure'] = '';
		}

		$this->template = 'setting/site_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function validateForm() {
		...
		if (!empty($this->request->post['config_member_group_display']) && !in_array($this->request->post['config_member_group_id'], $this->request->post['config_member_group_display'])) {
			$this->error['member_group_display'] = $this->language->get('error_member_group_display');
		}	
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $site_id) {
			...
			// $site_total = $this->model_members_order->getTotalOrdersBySiteId($site_id);
