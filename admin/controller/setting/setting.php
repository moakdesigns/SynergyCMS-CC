...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_post_count'] = $this->language->get('entry_post_count');
		...
		$this->data['entry_member_online'] = $this->language->get('entry_member_online');
		...
		if (isset($this->request->post['config_name'])) {
			...
			//$this->data['config_name'] = 'Your Site Name';
		}
		...
		if (isset($this->request->post['config_title'])) {
			...
			//$this->data['config_title'] = 'Your Site';
		}
		...
		if (isset($this->request->post['config_meta_description'])) {
			...
			//$this->data['config_meta_description'] = 'My Site';
		}
		...
		if (isset($this->request->post['config_post_count'])) {
			$this->data['config_post_count'] = $this->request->post['config_post_count'];
		} else {
			$this->data['config_post_count'] = $this->config->get('config_post_count');
		}
		...
		if (isset($this->request->post['config_member_online'])) {
			$this->data['config_member_online'] = $this->request->post['config_member_online'];
		} else {
			$this->data['config_member_online'] = $this->config->get('config_member_online');			
		}
		...
		if (isset($this->request->post['config_member_group_id'])) {
			...
			$this->data['config_member_group_id'] = $this->config->get('config_member_group_id');			
		}
		...
		} elseif ($this->config->get('config_member_group_display')) {
			$this->data['config_member_group_display'] = $this->config->get('config_member_group_display');	
		} else {
		...
		if (isset($this->request->post['config_image_post_width'])) {
			...
			$this->data['config_image_post_width'] = $this->config->get('config_image_post_width');
		}
		...
		if (isset($this->request->post['config_image_post_height'])) {
			...
			$this->data['config_image_post_height'] = $this->config->get('config_image_post_height');
		}
