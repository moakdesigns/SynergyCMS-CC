...
class ControllerCatalogInformation extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['information_site'])) {
			$this->data['information_site'] = $this->request->post['information_site'];
		} elseif (isset($this->request->get['information_id'])) {
			$this->data['information_site'] = $this->model_catalog_information->getInformationSites($this->request->get['information_id']);
		} else {
			$this->data['information_site'] = array(0);
		}		
