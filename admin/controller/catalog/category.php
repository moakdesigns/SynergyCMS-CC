...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['category_site'])) {
			$this->data['category_site'] = $this->request->post['category_site'];
		} elseif (isset($this->request->get['category_id'])) {
			$this->data['category_site'] = $this->model_catalog_category->getCategorySites($this->request->get['category_id']);
		} else {
			$this->data['category_site'] = array(0);
		}			
