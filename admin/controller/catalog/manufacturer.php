...
class ControllerCatalogManufacturer extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['manufacturer_site'])) {
			$this->data['manufacturer_site'] = $this->request->post['manufacturer_site'];
		} elseif (isset($this->request->get['manufacturer_id'])) {
			$this->data['manufacturer_site'] = $this->model_catalog_manufacturer->getManufacturerSites($this->request->get['manufacturer_id']);
		} else {
			$this->data['manufacturer_site'] = array(0);
		}	
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $manufacturer_id) {
			$post_total = $this->model_catalog_post->getTotalPostsByManufacturerId($manufacturer_id);
